...
public class Filesharer1 {
	...
	public static void main( String[] args ) throws IOException, InterruptedException{
		...
		int port = 3202; // the port this peer uses for other peers to connect to
    	...
    	textGUI.logInfo("using internet address ["+address.getHostName()+":"+port+"]"); // port:3201
